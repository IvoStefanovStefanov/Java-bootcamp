...
public class RoomApiUpdateTest {
    ...
    @BeforeClass
    public static void createNewTemporalRoom() {
    ...
    @Test
    public void updateRoomWithoutTokenMustReturnUnauthorized() {
    ...
    @Test
    public void updateRoomHaveToReturnOk() {
        String jwt = jwtTokenGenerator.generateAdminToken();
    ...
    @Test
    public void updateRoomWithEmptyBodyMustReturnBadRequest() {
        String jwt = jwtTokenGenerator.generateAdminToken();
    ...
    @Test
    public void updateNonExistingRoomWithTokenMustReturnNotFound() {
        String jwt = jwtTokenGenerator.generateAdminToken();
        String room = jsonResourcesReader.readFile("classpath:updateRoom.json");
        given()
                .header("Authorization", "Bearer " + jwt)
    ...
    @Test
    public void updateRoomWithClientTokenMustReturnForbidden() {
